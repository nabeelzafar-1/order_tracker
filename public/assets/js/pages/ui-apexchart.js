...
var lineOptions = {
  ...
  series: [
    {
      name: "Hour",
      data: timePerday.split(","),
    },
  ],
  xaxis: {
    categories: days.split(","),
  },
};
var candleOptions = {
series: [
...
//Average Time vs. Usage by Player Per Game
 var areaOptions = {
   series: [
     {
       name: "Avg Time",
       data: timePrday.split(","),
     },
     {
       name: "Usage by Player Per Game",
       data: gameTimePerday.split(","),
     },
   ],
   chart: {
     height: 350,
